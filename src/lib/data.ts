...
export const REVIEWS: Review[] = [
  ...
  },
  {
    ...
    reviewer_avatar: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=80&q=80",
    rating: 4,
    comment: "I found an amazing caterer and decorator within minutes. The package booking flow was super easy. Our guests are still talking about the event three months later!",
  ...
  },
  {
    ...
    reviewer_avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=80&q=80",
    rating: 4,
    comment: "Great platform for sourcing event vendors quickly. The vendor profiles are detailed and the booking confirmation was fast. Our product launch event was a huge success.",
